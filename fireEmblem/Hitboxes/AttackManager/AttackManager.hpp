...
namespace AttackManagers
{
    ...
    class AttackManager
    {
        ...
        public:
            ...
            AttackManager();
            void CreateAttack(std::string source, int atkValue, sf::Vector2f position);
            void CreateRangedAttack(std::string source, int atkValue, sf::Vector2f position, std::pair<int, int> directions);
